...
const Predictor = ({ vehicle, onPrediction }) => {
  ...
  const predictionInfos = [
    "Sending details...",
    "Analysing car condition...",
    "Estimating Price...",
  ]
  ...
  const getPrediction = async () => {
    GetStringsWithDelay(predictionInfos, (str)=>{setPreInfo(str)});
  ...
  return (
    <Box>
      ...
      <Box>
        ...
        {isPredicting && <Typography sx={{textAlign: 'center'}}>{preInfo}</Typography>}
      </Box>
    </Box>
  );
};
